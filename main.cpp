...
int main()
{
	...
	const int rectangleHeight = std::ceil(float(HEIGHT - (rectangleCountY * cellPadding)) / rectangleCountY);
	const int rectangleWidth = std::ceil(float(WIDTH - (rectangleCountX * cellPadding)) / rectangleCountX);
